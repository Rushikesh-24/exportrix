        ...
        <div className="bg-white rounded-lg shadow-xl overflow-hidden p-8">
          ...
          <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              ...
              type="submit"
              disabled={isLoading}
              className="w-full bg-black hover:scale-105 cursor-pointer text-white py-3 rounded-md hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black transition-all disabled:opacity-70 disabled:cursor-not-allowed"
            >
              {isLoading ? (
